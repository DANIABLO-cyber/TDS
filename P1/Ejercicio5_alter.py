...
img = Image.open("lena.png").convert("L")  # modo 'L' = escala de grises
...
print("Observación:")
print("- La imagen cuantificada sin dither tiene mayor SNR pero más 'banding' (zonas planas artificiales).")
print("- La imagen con dither tiene un SNR ligeramente menor debido al ruido añadido, pero el resultado visual es más natural.")
print("- El dither suaviza transiciones, evitando artefactos visibles causados por la cuantificación.")
